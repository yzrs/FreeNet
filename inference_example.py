...
def inference_test():
    ...
    # weights_path = "saved_weights/random_0.1_ap10k.pth"
    # model = HighResolutionNet(num_joints=17)

    # weights_path = "saved_weights/random_0.1_animalpose.pth"
    # model = HighResolutionNet(num_joints=20)

    weights_path = "saved_weights/random_0.1_tigdog.pth"
    model = HighResolutionNet(num_joints=19)
