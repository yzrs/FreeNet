...
from train_utils.ssl_utils import fixmatch
...
def main(cfg,args):
    ...
    fixmatch(cfg,args,train_label_loader,train_unlabel_loader,model,optimizer,scheduler,scaler,writer_dict)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description=__doc__)
    parser.add_argument('--name', default="fixmatch", type=str, help='experiment name')
    ...
    # 学习率
    parser.add_argument('--lr', default=1e-5, type=float,help='initial learning rate, 1e-3 is the default value for training')
