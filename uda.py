...
def main(cfg,args):
    ...
    uda(cfg,args,train_label_loader,train_unlabel_loader,t_model, s_model,
        t_optimizer,s_optimizer,t_scheduler, s_scheduler,t_scaler,s_scaler,writer_dict)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description=__doc__)
    parser.add_argument('--name', default="uda", type=str, help='experiment name')
