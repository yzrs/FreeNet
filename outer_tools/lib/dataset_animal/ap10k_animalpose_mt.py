...
from outer_tools.lib.dataset_animal.kpt_2d_base_mt_pseudol_v3 import Kpt2dSviewRgbImgTopDownDataset
from outer_tools.lib.dataset_animal.dataset_info import DatasetInfo
from outer_tools.lib.dataset_animal import ap10k_info, ap_10k_animal_pose_info
...
class AnimalAP10KMTDataset(Kpt2dSviewRgbImgTopDownDataset):
    ...
    AP-10K and Animal Pose keypoint indexes::
    ...
    def _load_coco_keypoint_annotation_kernel(self, img_id):
        ...
        for obj in objs:
            ...
            if self.image_set == 'train':
                if obj['image_id'] not in self.imageid_annot or obj['id'] not in self.imageid_annot_map[str(obj['image_id'])]:
                    use_label = False
                else:
                    use_label = True
