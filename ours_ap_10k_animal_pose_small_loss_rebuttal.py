...
from train_utils.ssl_utils import ours_ap10k_animalpose_small_loss
...
def main(cfg,args):
    ...
    ours_ap10k_animalpose_small_loss(cfg,args,train_label_loader,train_unlabel_loader,t_model, s_model,t_optimizer,s_optimizer,
